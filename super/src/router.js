...
import OrgAdminDashboard from './views/OrgAdminDashboard.vue';
import slogin from './Super/Login.vue';
...
const routes = [
  ...
  { path: '/aadmin', component: Main_Admin },
  { path: '/org-admin', component: OrgAdminDashboard},
  {
    path: '/slogin',
    name: 'Super Login',
    component: slogin
